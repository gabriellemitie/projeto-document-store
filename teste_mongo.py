import psycopg  # ou use 'psycopg' se for a nova versão
import pymongo
...
def connect_postgres():
    try:
        conn = psycopg.connect('postgresql://postgres:12345678@localhost:5432/postgres') 
...
def connect_mongo():
    try:
        ...
        db = client['projetoMongo']  # Escolha o nome do banco de dados do MongoDB
